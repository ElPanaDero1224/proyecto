...
@section('modulo', 'Agregar Destinos')
...
<div class="container mt-4">
    ...
    <div class="text-center mb-4">
        <h1 class="display-4">Agregar Destino</h1>
        <p class="text-muted">Llena los campos necesarios para agregar un nuevo destino a la lista.</p>
    </div>
